  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[350px] max-w-full shrink-0 rounded-2xl border border-zinc-200/20 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm px-8 py-6 md:w-[450px] dark:border-zinc-700/20 dark:from-zinc-900/50 dark:to-zinc-800/30"
            key={item.name}
          >
            <blockquote>
              <div
