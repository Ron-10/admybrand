...
export default function GlobeDemo() {
  ...
  return (
    <div className="flex flex-row items-center justify-center py-20 h-screen md:h-auto bg-gradient-cosmic relative w-full">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4">
        ...
        >
          <h2 className="text-center text-xl md:text-4xl font-bold text-foreground">
            Global AI Marketing Reach
          </h2>
          <p className="text-center text-base md:text-lg font-normal text-muted-foreground max-w-md mt-2 mx-auto">
            Our AI-powered marketing solutions connect businesses worldwide, creating 
            seamless digital experiences across continents and cultures.
          </p>
        </motion.div>
